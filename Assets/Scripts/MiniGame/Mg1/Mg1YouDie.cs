...
public class Mg1YouDie : MonoBehaviour
{
    ...
    IEnumerator ResetPlayerPosition()
    {
        ...
        Mg1Player playerComponent = player.GetComponent<Mg1Player>();
        ...
        if (playerEntered)
        {
            ...
            Mg1Player newPlayerComponent = newPlayer.GetComponent<Mg1Player>();
