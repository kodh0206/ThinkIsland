...
public class dMg16Battery : MonoBehaviour
{
    public dMg16Manager manager;
    public dMg16Player playerPositionScript;
    ...
    {
        // Mg16manager 인스턴스 할당
        manager = FindObjectOfType<dMg16Manager>();
        playerPositionScript = FindObjectOfType<dMg16Player>();
    }
